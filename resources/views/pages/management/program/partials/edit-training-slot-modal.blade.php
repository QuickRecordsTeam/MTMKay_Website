<x-modal name="update-training-slot-modal{{$value->id}}" :show="$errors->isNotEmpty()" focusable x-data="update-training-slot-modal">
   <div class="p-6">
       <form method="post" action="{{ route('manage.training.slot.update', ['slug' => $value->slug]) }}" >
           ...
           <div class="grow my-4">
               ...
               <x-input-error class="mt-2" :messages="$errors->first('start_time')"/>
           </div>
           ...
           <div class="grow my-4">
               ...
               <x-input-error class="mt-2" :messages="$errors->first('end_time')"/>
           </div>
           ...
           <div class="grow my-4">
               ...
               <x-input-error class="mt-2" :messages="$errors->first('available_seats')"/>
           </div>
